...
def openNewWindow():
    ...
    name_label = tk.Label(newWindow, text = 'Username', font=('calibre',10, 'bold'))
    # creating a entry for input
    # name using widget Entry
    name_entry = tk.Entry(newWindow,textvariable = name_var, font=('calibre',10,'normal'))
      
    # creating a label for password
    passw_label = tk.Label(newWindow,text = 'Encryption Password:', font = ('calibre',10,'bold'))
      
    # creating a entry for password
    passw_entry=tk.Entry(newWindow, textvariable = passwd_var, font = ('calibre',10,'normal'), show = '*')
...
label_file_explorer = tk.Label(root,text = "File Selector",fg = "blue",font = ('calibre',12,'normal'))

	
button_explore =tk. Button(root,text = "Browse Files",font = ('calibre',12,'normal'),command = browseFiles)
...
def filesplit():
    ...
    fs = Filesplit()
    fs.split(file=selectedfilename, split_size=500000, output_dir=os.getcwd()+"\song", callback=split_cb)
...
# creating a label for password
passw_label = tk.Label(root, text = 'Encryption Password:', font = ('calibre',12,'bold'))
  
# creating a entry for password
passw_entry=tk.Entry(root, textvariable = passw_var, font = ('calibre',12,'normal'), show = '*')
  
# creating a button using the widget
# Button that will call the submit function
enc_btn=tk.Button(root,text = 'Encrypt',font = ('calibre',12,'normal'), command = encryptfile)
decr_btn=tk.Button(root,text = 'Decrypt',font = ('calibre',12,'normal') ,command = openNewWindow)

merge_btn=tk.Button(root,text = 'Merge',font = ('calibre',12,'normal') ,command = mergefiles)
...
# method
Process_label = tk.Label(root, text = 'Welcome to the File System!!!', font=('calibre',12, 'bold'))
